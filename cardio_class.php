...
$sqlCount = "SELECT COUNT(*) as booked_slots FROM bookings WHERE cardio_class_schedule;"
$resultCount = $conn->query($sqlCount);
$bookedSlots = $resultCount->fetch_assoc()['booked_slots'];
?>
...
<head>
    ...
    <title>Cardio Class Schedule</title>
    <link rel="stylesheet" type="text/css" href="cardio_class.css"/>
